...
<html>
<head>
<title>KITCHEN | MODIFY/DELETE PRODUCT</title>
<script
...
<div class="wrapper">
	<div class="title">
		<h1>KITCHEN | Modify/Delete Product</h1><br>
	</div>
    <form method="post">
    ...
    while($row = mysqli_fetch_assoc($result)) { ?>
        ...
        if (isset($_POST["update"])){
            ...
            if (mysqli_query($con, $sql)) {
                ...
                window.location.href='k_modifydelete.php';</script>";
                }
            else { 
                echo "<script>alert('Could not update!'); 
                window.location.href='k_modifydelete.php';
                </script>"; }
        ...
        <td>
        <?php 
        $remove = "<a href='k_deleteproduct.php?pid={$row['product_id']}' style='text-decoration: none; color: #000000';>Remove</a>";
        echo $remove;
        ?>
		</td>
        </form>
