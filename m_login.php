...
if (isset($_POST['signup'])) { 
   ...
   $sql = "INSERT INTO manager (m_name, ic, password)
   VALUES
   ('$_POST[m_name]','$_POST[ic]','$_POST[password]')";
   
   if (!mysqli_query($con, $sql)){
      die('Error: ' . mysqli_error($con));
   }else {
      echo '<script>alert("New manager account added successfully! Please login with your account to get access to the system!");
...
if (isset($_POST['login'])){
   ...
   $result=mysqli_query($con,"SELECT * FROM manager WHERE ic='$ic' AND password='$password' limit 1"); //==+1
   ...
   if(mysqli_num_rows($result)==1)  
   {
      ...
      //back to home
      echo"<script>
         alert('Welcome, {$_SESSION['m_name']}! You have successfully login.');
         </script>";
      echo"<script>window.location.href='m_home.php';</script>";
   }
   else
      echo"<script>
      ...
      <div class="form-container">
         ...
         <div class="form-inner">
            ...
            <form action="" class="signup" method="post">
               <div class="field">
                 <input type="text" name="m_name" placeholder="Full Name" required>
               </div>
               <div class="field">
